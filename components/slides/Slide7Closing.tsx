...
export default function Slide7Closing() {
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-12 md:py-24 text-center">
        {/* Status Indicator - matching cover */}
        ...
        {/* Main Title */}
        <motion.h1 variants={itemVariants} className="font-sans text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 md:mb-8">
          {closingContent.title}
        </motion.h1>

        {/* Subtitle */}
        <motion.h2 variants={itemVariants} className="font-sans text-xl sm:text-2xl md:text-3xl text-gray-400 mb-12 md:mb-20">
          {closingContent.subtitle}
        </motion.h2>

        {/* Signature Line */}
        <motion.div variants={itemVariants} className="pt-6 border-t border-white/10 pb-12 md:pb-0">
